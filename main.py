...
buttonRed = Pin(27, Pin.IN, Pin.PULL_UP) # Start/Stop
buttonYellow = Pin(28, Pin.IN, Pin.PULL_UP) # Reverse
buttonGreen = Pin(20, Pin.IN, Pin.PULL_UP) # Reset
playflag = 0
pauseflag = 0
